...
class RecentTransactionsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return withCurrentUser<Widget>((user) {
          return StreamBuilder<List<Expense>>(
            stream: FirestoreService().getExpenses(user.uid, limit: maxItems),
            builder: (context, snapshot) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Text('no_expenses_to_display'.tr())),
                      ],
                    ),
                  ),
                );
              ...
              final recent =
                  expenses; // Already sorted and limited by Firestore
